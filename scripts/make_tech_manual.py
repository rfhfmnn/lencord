...
<body>
    ...
    <div class="cover">
        <div class="cover-top">
            ...
            <div class="cover-badge">Documentación de Ingeniería & Operaciones</div>
 ...
 ✓ Ready in 1200ms</code></pre>
        ...
        <p>
            Abra su navegador web favorito e ingrese a la siguiente dirección URL:
        </p>
        ...
        <h3>Paso 3.4: Ejecución en Puerto Alternativo (en caso de puerto 3000 ocupado)</h3>
        <p>
        ...
        <h3>4.2. Método Forzado / Proceso en Segundo Plano (Windows PowerShell)</h3>
        <p>
